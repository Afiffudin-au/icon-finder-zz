    ...
    <div className="searchIconResult">
       {
        ...
        <BottomNavigation
          ...
          >
          <BottomNavigationAction onClick={()=> getSearch(query,catagory,style,0)} label="All icons" icon={<EmojiSymbolsIcon />} />
          <BottomNavigationAction onClick={()=> getSearch(query,catagory,style,0,'false')} label="Free icons" icon={<MoneyOffIcon />} />
          <BottomNavigationAction onClick={()=> getSearch(query,catagory,style,0,'true')} label="Premium" icon={<AttachMoneyIcon />} />
          <BottomNavigationAction onClick={()=> getSearch(query,catagory,style,0,'','true')} label="Vector" icon={<BrushIcon />} />
        </BottomNavigation>
