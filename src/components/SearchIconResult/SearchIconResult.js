  ...
  return (
    <div className='searchIconResult'>
      ...
      <BottomNavigation
        ...
        <BottomNavigationAction
          onClick={() => getSearch(query, catagory, style, 0)}
          label='All icons'
          icon={<EmojiSymbolsIcon />}
        />
        <BottomNavigationAction
          onClick={() => getSearch(query, catagory, style, 0, 'false')}
          label='Free icons'
          icon={<MoneyOffIcon />}
        />
        <BottomNavigationAction
          onClick={() => getSearch(query, catagory, style, 0, 'true')}
          label='Premium'
      ...
      {allIcons.icons && (
        <div className='searchIconResult__pagenation'>
          <Pagination
            color='secondary'
            variant='outlined'
