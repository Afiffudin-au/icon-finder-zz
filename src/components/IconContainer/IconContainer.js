...
function IconContainer() {
  ...
  return (
    <div className='IconsContainer'>
      {loading && (
        <div
          style={{ position: 'sticky', top: '0', marginBottom: '5px' }}
          className='loading'>
      ...
      <BottomNavigation
        ...
        <BottomNavigationAction
          onClick={() => getAllIcons(0)}
          label='All icons'
          icon={<EmojiSymbolsIcon />}
        />
        <BottomNavigationAction
          onClick={() => getAllIcons(0, 'false')}
          label='Free icons'
          icon={<MoneyOffIcon />}
        />
        <BottomNavigationAction
          onClick={() => getAllIcons(0, 'true')}
          label='Premium'
      ...
      {allIcons.icons && (
        <div className='IconsContainer__pagenation'>
          <Pagination
            color='secondary'
            variant='outlined'
