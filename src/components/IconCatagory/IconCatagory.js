  ...
  return (
    <div className='IconCatagory'>
      ...
      <BottomNavigation
        ...
        <BottomNavigationAction
          onClick={() => GetIconCatagory(catagory, style)}
          label='All icons'
          icon={<EmojiSymbolsIcon />}
        />
        <BottomNavigationAction
          onClick={() => GetIconCatagory(catagory, style, 0, 'false', '')}
          label='Free icons'
          icon={<MoneyOffIcon />}
        />
        <BottomNavigationAction
          onClick={() => GetIconCatagory(catagory, style, 0, 'true', '')}
          label='Premium'
      ...
      {allIcons.icons && (
        <div className='IconCatagory__pagenation'>
          <Pagination
            color='secondary'
            variant='outlined'
