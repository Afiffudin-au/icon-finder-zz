  ...
  return (
    <div className='IconStyle'>
      ...
      <BottomNavigation
        ...
        <BottomNavigationAction
          onClick={() => getIconStyle(style, catagory)}
          label='All icons'
          icon={<EmojiSymbolsIcon />}
        />
        <BottomNavigationAction
          onClick={() => getIconStyle(style, catagory, 0, 'false', '')}
          label='Free icons'
          icon={<MoneyOffIcon />}
        />
        <BottomNavigationAction
          onClick={() => getIconStyle(style, catagory, 0, 'true', '')}
          label='Premium'
      ...
      {allIcons.icons && (
        <div className='IconStyle__pagenation'>
          <Pagination
            color='secondary'
            variant='outlined'
